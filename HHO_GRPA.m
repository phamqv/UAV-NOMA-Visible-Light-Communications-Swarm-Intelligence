% =========================================================================
% The HHO for the GRPA algorithm
% =========================================================================
...
function [Rabbit_Energy,Rabbit_Location,CNVG,All_Location] = HHO_GRPA(sim_para,lb,ub,dim,fobj,coordinate_GUs,power)
...
X = initialization_GRPA(sim_para,dim,ub,lb,coordinate_GUs,power);
