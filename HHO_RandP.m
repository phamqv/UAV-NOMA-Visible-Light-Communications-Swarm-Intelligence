% =========================================================================
% The HHO for the RandP algorithm
% =========================================================================
...
function [Rabbit_Energy,Rabbit_Location,CNVG,All_Location] = HHO_RandP(sim_para,lb,ub,dim,fobj,coordinate_GUs,coordinate_UAV)
...
X = initialization_RandP(sim_para,dim,ub,lb,coordinate_GUs,coordinate_UAV);
