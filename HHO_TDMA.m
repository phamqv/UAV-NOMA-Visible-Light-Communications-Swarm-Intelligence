% =========================================================================
% The HHO algorithm for the TDMA scheme 
% =========================================================================
...
function [Rabbit_Energy,Rabbit_Location,CNVG,All_Location] = HHO_TDMA(sim_para,lb,ub,dim,fobj,coordinate_GUs)
...
X = initialization_TDMA(sim_para,dim,ub,lb,coordinate_GUs);
