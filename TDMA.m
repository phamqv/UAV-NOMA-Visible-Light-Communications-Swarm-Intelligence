% =========================================================================
% This function is to implement the TDMA algorithm
% =========================================================================
...
function [ solution, obj_value, conv_curve,all_solution ] = TDMA( sim_para, coordinate_GUs )

    % run the HHO algorithm to solve the problem
    [lb, ub, dim, fobj] = obj_function_TDMA( sim_para, coordinate_GUs );
    [obj_value,solution,conv_curve,all_solution] = HHO_TDMA(sim_para,lb,ub,dim,fobj,coordinate_GUs);
